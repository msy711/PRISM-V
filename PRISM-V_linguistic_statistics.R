...
internal_file <- "C:/Users/msy71/OneDrive/바탕 화면/PRISM-V/prism_datacleaned/longi_internal.csv"
external_file <- "C:/Users/msy71/OneDrive/바탕 화면/PRISM-V/prism_datacleaned/longi_external.csv"
...
head(merged_df)
write.csv(merged_df, "C:/Users/msy71/OneDrive/바탕 화면/PRISM-V/prism_datacleaned/npj_longitudinal_all.csv", row.names = FALSE)

data_within_all <- read.csv("C:/Users/msy71/OneDrive/바탕 화면/PRISM-V/prism_datacleaned/npj_longitudinal_all.csv", header=TRUE, stringsAsFactors=FALSE)
...
data_within_all <- read.csv("C:/Users/msy71/OneDrive/바탕 화면/PRISM-V/prism_datacleaned/npj_longi_all.csv", header=TRUE, stringsAsFactors=FALSE) # with AP data
