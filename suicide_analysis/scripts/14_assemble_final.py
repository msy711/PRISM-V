...
<div class="callout"><b>최근 문헌과의 비교 —</b> "발병 후 첫 3개월과 첫 5년이 가장 고위험 시기"라는 소견은 100명
입원환자 대상의 고전적 연구(Malone et al., <i>J Affective Disorders</i>, 1995)에서 처음 보고된 이래 반복적으로
재확인되어 왔으며, 미치료 이환기간이 길수록 위험요인의 구성 자체가 달라진다는 최신 연구(2024)와 초발·조기발병
우울증의 노모그램 기반 예측모형 연구들(2025)도 발병 시점 근접성이 핵심 변수임을 강조합니다. 본 분석은 재발성
우울장애 여성 3,000명이라는 상대적으로 큰 동양인 표본에서, Kaplan–Meier 생존분석과 CSA·아형·발병연령 층화를
결합해 이 고전적 소견을 <b>현대적 방법론으로 재확인·정량화</b>했다는 점에서 의의가 있습니다.</div>
</section>
""")
