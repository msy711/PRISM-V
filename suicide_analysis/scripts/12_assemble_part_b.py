...
<div class="callout"><b>최근 문헌과의 비교 —</b> 2025년 발표된 5년 추적연구("Five-Year Outcomes of First Suicide
Attempts: Insights on Lethality, Recurrence, and Mortality", <i>J Clin Psychiatry</i>)는 첫 시도자의 상당수가
재시도를 경험하며 첫 시도의 치명도·물질사용이 이후 경과를 예측한다고 보고했습니다. 소아청소년 대상 체계적
문헌고찰(PMC, 2023)과 한국 10년 자살시도 레지스트리 연구(<i>J Korean Med Sci</i>, 2024)도 여성·낮은 교육수준·
불안/정신병적 장애 동반이 재시도 위험과 연관됨을 보고했는데, 이는 본 결과에서 <b>반복시도가 신경증이라는
성격 차원과 더 강하게 연관되고, 급성 임상 심각도 지표와는 상대적으로 약하게 연관</b>된 것과 맥을 같이 합니다 —
"누가 처음 시도하는가"와 "이미 시도한 사람 중 누가 반복하는가"는 서로 다른 예측변수 세트를 필요로 한다는 점에서
일관됩니다.</div>
</section>
""")
